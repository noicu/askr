...
/// [EffectLine] 使用 [TexturedLine] 绘制线动画。
/// 可以用于绘制烟雾轨迹、电效果或其它的线条动画。
class EffectLine extends Node {
  /// 使用指定的参数创建新的效果线。只有 [texture] 参数是必需的，其他所有参数都是可选的。
  EffectLine({
